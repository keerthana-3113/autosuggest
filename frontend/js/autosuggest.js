...
var searchSuggestions = document.getElementById("search-sugg");
...
function showSuggestions(data){
    ...
    if(data.count == 0){
        //innerHTML is used for changing the content of the element in the UI
        //innerText is used for changing the text content of the element in the UI
